...
const NewLibraryView = () => {
  ...
  const currentStories = activeTab === "library" ? libraryStories : downloadedStories;
    ...
    <div className="min-h-screen bg-accent-shade-1 max-w-[28rem] mx-auto pb-20">
      ...
      {activeTab === "downloads" && downloadedStories.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          ...
          <h3 className={`text-sm text-primary-colour text-center mb-2 ${Magnetik_Medium.className}`}>
            No downloaded stories
          </h3>
          <p className={`text-xs text-primary-shade-4 text-center mb-6 ${Magnetik_Regular.className}`}>
