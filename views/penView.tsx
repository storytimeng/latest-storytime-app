  ...
  const EmptyState = () => (
    <div className="min-h-screen bg-accent-shade-1 max-w-[28rem] mx-auto relative">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        {/* Illustration */}
        <div className="w-32 h-32 mb-8 flex items-center justify-center bg-complimentary-colour/10 rounded-2xl">
        ...
        <Button
          variant="bordered"
          className="w-full py-4 border-dashed border-primary-colour bg-transparent text-primary-colour hover:bg-primary-colour/5"
  ...
  const MyStoriesPreview = () => (
    <div className="space-y-6">
      ...
      <div className="pt-8">
        <Button
          variant="bordered"
          className="w-full  border-2 border-dashed border-complimentary-colour bg-transparent text-complimentary-colour hover:bg-complimentary-colour/5"
          onPress={() => router.push("/new-story")}
        >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="light"
            className="text-grey-2 body-text-smallest-medium-auto p-0 h-auto"
    ...
    <div className="space-y-6">
      ...
      {filteredStories.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <div className="w-16 h-16 mb-4 flex items-center justify-center bg-light-grey-2 rounded-full">
    ...
    return (
      <>
        <div className="min-h-screen bg-accent-shade-1 max-w-[28rem] mx-auto px-4 pb-6">
          ...
          <div className="flex items-center justify-center relative pt-4 mb-6">
            <button
        ...
        >
          <ModalContent>
            <ModalHeader className="flex items-center justify-between px-6 pt-6 pb-4">
              ...
              <h2 className="body-text-small-medium-auto text-primary-colour flex-1 text-center">
                Delete Story
              </h2>
              <button onClick={cancelDelete} className="text-primary-colour">
                <X size={20} />
            ...
            <ModalBody className="px-6 py-8">
              <p className="body-text-small-medium-auto text-primary-colour text-center">
                Are you sure you want to delete &ldquo;{storyToDelete?.title}
                &rdquo;
              </p>
            </ModalBody>

            <ModalFooter className="px-6 pb-6 pt-0 flex gap-4">
              <Button
                onPress={cancelDelete}
                className="flex-1 bg-transparent border-2 border-primary-colour text-primary-colour rounded-full py-6 body-text-small-medium-auto"
              >
                No
              </Button>
              <Button
                onPress={confirmDelete}
                className="flex-1 bg-primary-shade-6 text-universal-white rounded-full py-6 body-text-small-medium-auto"
              >
                Yes
              </Button>
            </ModalFooter>
