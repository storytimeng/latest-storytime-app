    ...
    <div className="min-h-screen bg-accent-shade-1 max-w-[28rem] mx-auto">
      ...
      <div className="px-4 pb-24 space-y-8">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h1 className={`text-xl text-primary-colour ${Magnetik_SemiBold.className}`}>
            Storytime Premium
          </h1>
        </div>
        ...
        <div className="space-y-6">
          {features.map((feature, index) => (
            <div key={index} className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-complimentary-colour/10 rounded-lg flex items-center justify-center">
                {feature.icon}
              </div>
              <div className="flex-1">
                <h3 className={`text-md text-primary-colour mb-1 ${Magnetik_SemiBold.className}`}>
                  {feature.title}
                </h3>
                <p className={`text-primary-shade-4 text-sm ${Magnetik_Regular.className}`}>
                  {feature.description}
                </p>
              </div>
            </div>
              ...
              >
                <div className="text-center space-y-3">
                  <div className={`text-[12px] leading-tight ${
                    selectedPlan === plan.id ? "text-universal-white" : "text-primary-shade-4"
                  ...
                  <div className={`text-md font-bold text-center ${
                    selectedPlan === plan.id ? "text-universal-white" : "text-primary-colour"
        ...
        <div className="text-center space-y-6">
          <p className={`text-primary-colour text-[14px] ${Magnetik_Medium.className}`}>
