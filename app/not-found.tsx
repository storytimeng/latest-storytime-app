...
export const metadata: Metadata = {
  ...
  description:
    "The page you're looking for doesn't exist. Head back to Storytime to discover amazing stories.",
...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-accent-shade-1 flex flex-col items-center justify-center px-6 text-center">
      ...
      <h2
        className={`text-xl text-primary-colour mb-3 ${Magnetik_Bold.className}`}
      >
        Page Not Found
      </h2>
      <p
        className={`text-primary-shade-4 text-sm max-w-sm mb-10 leading-relaxed ${Magnetik_Regular.className}`}
      >
        Looks like this page went missing - maybe it's hiding inside a great
        story. Head back and keep exploring.
      </p>
      ...
      {/* Subtle brand */}
      <p
        className={`mt-12 text-xs text-primary-shade-3 ${Magnetik_Regular.className}`}
      >
