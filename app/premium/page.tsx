...
export const metadata: Metadata = {
  ...
  description:
    "Unlock exclusive stories, ad-free reading, and premium features on Storytime. Upgrade to Premium and enjoy unlimited access to the best African fiction.",
  alternates: { canonical: `${APP_CONFIG.url}/premium` },
  openGraph: {
    title: "Storytime Premium - Unlimited Reading",
    description:
      "Unlock exclusive stories, ad-free reading, and premium features on Storytime.",
